...
import { type SignupInput } from "../../../common/src/index.ts";
    ...
    return <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-8">
                    {type === "signup" ? <LabelledInput label="Name" placeholder="amitesh" Onchange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            name: e.target.value
                        });
                    }} /> : null}
                    <LabelledInput label="Username" placeholder="amitesh@gmail.com" Onchange={(e) => {
                        setPostInputs({
                            ...postInputs,
...
function LabelledInput({ label, placeholder, Onchange, type }: LabelledInputProps) {
    return <div>
        <label className="block md-2 text-sm  text-black font-semibold pt-4">{label}</label>
